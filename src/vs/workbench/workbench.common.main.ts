...
// UmiCode Defaults (Prettier, format-on-save) + Smart Setup (language detection) + Run File / Preview + Guards
import './contrib/umiDefaults/browser/umiDefaults.contribution.js';
import './contrib/umiDefaults/browser/umiSmartSetup.contribution.js';
import './contrib/umiDefaults/browser/umiRunFile.contribution.js';
import './contrib/umiDefaults/browser/umiWorkspaceOnboarding.contribution.js';
import './contrib/umiDefaults/browser/umiLocalhostDetector.contribution.js';
import './contrib/umiDefaults/browser/umiEnvFileGuard.contribution.js';
import './contrib/umiDefaults/browser/umiGitGuard.contribution.js';
