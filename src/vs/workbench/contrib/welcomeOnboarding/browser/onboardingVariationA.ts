...
const defaultChat = product.defaultChatAgent ?? {
	...
	signUpUrl: '',
	provider: {
		default: { id: '', name: 'GitHub' },
		enterprise: { id: '', name: 'GitHub Enterprise' },
		google: { id: '', name: 'Google' },
		apple: { id: '', name: 'Apple' },
		microsoft: { id: '', name: 'Microsoft' },
	},
	providerExtensionId: '',
	providerUriSetting: '',
	providerScopes: [],
...
export class OnboardingVariationA extends Disposable implements IOnboardingService {
	...
	show(): void {
		...
		this.overlay.setAttribute('aria-label', localize('onboarding.a.aria', "Welcome to UmiCode"));
	...
	private _renderSignInStep(container: HTMLElement): void {
		...
		title.textContent = localize('onboarding.signIn.heroTitle', "Welcome to UmiCode");
	...
	private _renderPersonalizeSubtitle(container: HTMLElement): void {
		...
		container.append(
			...
			localize('onboarding.personalize.tip.suffix', " to access all UmiCode commands."),
		);
	}
