...
export class StartupPageRunnerContribution extends Disposable implements IWorkbenchContribution {
	...
	private tryShowOnboarding(): void {
		...
		if (this.chatEntitlementService.sentiment.hidden || !this.productService.defaultChatAgent) {
			return; // AI features are hidden or no default chat agent, do not show AI-focused onboarding
		}
